...
public class MusiclibraryApplication {
	...
	public CommandLineRunner playlistDemo(SongRepository songRepository, PlaylistRepository playlistRepository, GenreRepository genreRepository, UserRepository userRepository) {
		return (args) -> {
			...
			Genre g0 = new Genre("");
			genreRepository.save(g0);
			Genre g1 = new Genre("Pop");
			genreRepository.save(g1);
			Genre g2 = new Genre("Hip hop");
			genreRepository.save(g2);
			Genre g3 = new Genre("Rock");
			genreRepository.save(g3);
			Genre g4 = new Genre("Rap");
			genreRepository.save(g4);
			Genre g5 = new Genre("R&B");
			genreRepository.save(g5);
			Genre g6 = new Genre("EDM");
			genreRepository.save(g6);
			Genre g7 = new Genre("Country");
			genreRepository.save(g7);
			Genre g8 = new Genre("Jazz");
			genreRepository.save(g8);
			Genre g9 = new Genre("Reggae");
			genreRepository.save(g9);
			Genre g10 = new Genre("Classical");
			genreRepository.save(g10);
			Genre g11 = new Genre("Suomipop");
			genreRepository.save(g11);
			
			Song s1 = new Song("Tuulisii", "Jvg", 3.40, g11);
			songRepository.save(s1);
			Song s2 = new Song("Mikä kesä", "Valvomo", 3.33, g11);
			songRepository.save(s2);
			Song s3 = new Song("Mitä silmät ei nää", "Juha Tapio", 3.42, g11);
			songRepository.save(s3);
			Song s4 = new Song("Sulle tehty", "Abreu", 3.21, g4);
			songRepository.save(s4);
			Song s5 = new Song("Huhtikuu", "Ellis", 2.45, g11);
			songRepository.save(s5);
			Song s6 = new Song("Purple Haze", "Jimi Hendrix", 2.53, g3);
			songRepository.save(s6);
			Song s7 = new Song("Jolene", "Dolly Parton", 2.42, g7);
			songRepository.save(s7);
			Song s8 = new Song("A Lalala Long", "Bob Marley", 3.47, g9);
			songRepository.save(s8);
			Song s9 = new Song("Wake me up", "Avicii", 4.33, g6);
			songRepository.save(s9);
			Song s10 = new Song("In da Club", "50 Cent", 4.08, g4);
			songRepository.save(s10);
			Song s11 = new Song("Illusion", "Dua Lipa", 3.08, g1);
			songRepository.save(s11);
			Song s12 = new Song("Greedy", "Tate McRae", 2.12, g1);
			songRepository.save(s12);
			Song s13 = new Song("Hotline Bling", "Drake", 4.25, g1);
			songRepository.save(s13);
			Song s14 = new Song("Staying alive", "Bee Gees", 4.45, g1);
			songRepository.save(s14);
			Song s15 = new Song("Someone like you", "Adele", 4.45, g1);
